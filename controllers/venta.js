...
function obtenerVenta(req, res){
    let Venta1 = new Venta(1, '20210904 15:30:05', 433.21 , 3 , 1 , 'Transferencia');    
    let Venta1 = new Venta(2, '20210903 11:20:10', 433.21 , 3 , 1 , 'Transferencia');

    res.send([Venta1, Venta2]);
}

function modificarVenta(req , res){
    let Venta = new Venta(req.params.id, '20210903 11:20:10', 433.21 , 3 , 1 , 'Transferencia');
